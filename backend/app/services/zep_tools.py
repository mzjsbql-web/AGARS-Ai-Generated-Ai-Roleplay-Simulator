...
logger = get_logger('agars.zep_tools')
...
class ZepToolsService:
    ...
    def _generate_sub_queries(
        ...
        """
        system_prompt = get_system('sub_query')

        report_context_section = f"报告上下文：{report_context[:500]}" if report_context else ""
        user_prompt = safe_render(get_template('sub_query'), {
            'simulation_requirement': simulation_requirement,
            'report_context_section': report_context_section,
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = get_system('agent_selection')

        user_prompt = safe_render(get_template('agent_selection'), {
            'interview_requirement': interview_requirement,
            'simulation_requirement': simulation_requirement if simulation_requirement else "未提供",
            'total_agents': str(len(agent_summaries)),
    ...
    def _generate_interview_questions(
        ...
        system_prompt = get_system('interview_questions')

        user_prompt = safe_render(get_template('interview_questions'), {
            'interview_requirement': interview_requirement,
            'simulation_requirement': simulation_requirement if simulation_requirement else "未提供",
    ...
    def _generate_interview_summary(
        ...
        system_prompt = get_system('interview_summary')

        user_prompt = safe_render(get_template('interview_summary'), {
            'interview_requirement': interview_requirement,
