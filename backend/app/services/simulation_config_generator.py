...
from .prompt_config import get_system

logger = get_logger('agars.simulation_config')
    ...
    def _call_llm_with_retry(self, prompt: str, system_prompt: str) -> Dict[str, Any]:
        ...
        for attempt in range(max_attempts):
            try:
                ...
                _mon_dur = (_t.time() - _mon_start) * 1000
                ...
                monitor.log_full(source="SimulationConfigGenerator", model=self.model_name, messages=_mon_msgs, response=content, duration_ms=_mon_dur, tokens=_mon_tok)
...
- reasoning (string): 简要说明为什么这样配置"""
        ...
        system_prompt = get_system('sim_time_config')
...
{{
    ...
    "reasoning": "<简要说明>"
        ...
        system_prompt = get_system('sim_event_config')
...
{{
    "agent_configs": [
        ...
        system_prompt = get_system('sim_agent_config')
